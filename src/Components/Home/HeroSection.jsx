...
const HeroSection = () => {
  const { searchMode, setSearchMode } = useContext(UIContext);
  return (
    <section
      className="
    ...
    >
      ...
      <div className="lg:max-w-4xl md:max-w-2xl max-w-s mx-auto text-center mt-6 px-4 pb-12 relative z-10">
        ...
        <div className="flex flex-col items-center justify-center gap-3 mb-12">
          <div className="relative">
            ...
            {searchMode === "AI" && (
              <div className="flex items-center bg-white/10 border border-white/20 p-1 lg:p-3 rounded-full w-[350px] md:w-[480px] backdrop-blur-md">
                <input
                  type="text"
                  placeholder="e.g., Looking for Link software developer job in delhi"
          ...
          {searchMode === "Manual" && (
            <div className="flex flex-wrap gap-2 max-w-[700px] mt-3">
              <p className="font-bold text-white pt-0.5">Popular Searches:</p>
              {[
                "Data Analyst",
                "Accountant",
                "Consulting",
